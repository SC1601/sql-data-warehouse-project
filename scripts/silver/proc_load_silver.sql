        ...
        BEGIN TRY
            ...
            select 
               ...
               ,CAST( 
	                 ...
	                 AS DATE
	             ) AS prd_end_dt --Calcuate end date as one day before the next start date	
            ...
            SELECT
                    CASE WHEN cid LIKE 'NAS%' THEN SUBSTRING(CID, 4, LEN(CID)) --Remove NAS as prefix if present
                         ELSE cid
                    END AS cid 
